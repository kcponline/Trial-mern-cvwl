				...
				<div className="container" style={{width: '100%',padding: '0px',fontType: 'Serif'}}>
					...
					<div className="jumbotron" style={{padding: '10px', background: 'steelblue', color: 'white', borderRadius: '0px'}}>
						...
						<p>
							...
							<a className="btn btn-danger btn-lg" type="button" onClick={this.mainClick}>Vital Websites</a>
							<span> </span>
							<a className="btn btn-danger btn-lg" type="button" onClick={this.handleClick}>Templates</a>
							<span> </span>
							<a className="btn btn-danger btn-lg" type="button" onClick={this.resetClick}>Contacts</a>
							<span> </span>
							<a className="btn btn-danger btn-lg" type="button" onClick={this.handleClick}>Show All</a>
							<span> </span>
