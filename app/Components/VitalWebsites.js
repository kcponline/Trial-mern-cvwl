										...
										<div className="panel">
											{/*<ul className="nav nav-pills nav-stacked">
												...
												<ol class="nav nav-pills nav-stacked"  style={{color: 'white',fontSize: '18px'}}>
													...
													<li role="presentation" className="active"><a href="http://voice.lightspar.com" target="_blank" style={{color: '#e6f5ff'}}>Lightspar: QRS business phone system online user account access</a></li>		
													...
													<li role="presentation" className="active"><a href="https://www.google.com/url?q=https://www.cms.gov/Research-Statistics-Data-and-Systems/Files-for-Order/Data-Disclosures-Data-Agreements/DUA_-_DSH.html&sa=D&source=hangouts&ust=1519311406734000&usg=AFQjCNFRD5weTZR9wiocNhqP2OgnZE8fig" target="_blank" style={{color: '#e6f5ff'}}>DUA Instruction: CMS DSH DUA instructions</a></li>
